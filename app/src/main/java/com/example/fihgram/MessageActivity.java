...
public class MessageActivity extends AppCompatActivity {
   ...
   String usernameOfTheRoommate , emailOfRoommate , chatRoomId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(MessageActivity.this).load(getIntent().getStringExtra("img_of_roommate")).placeholder(R.drawable.baseline_person_24).error(R.drawable.baseline_person_24)
                        .into(imgToolbar);
