...
public  class UsersAdapter extends RecyclerView.Adapter <UsersAdapter.UserHolder> {
    ...
    public void onBindViewHolder(@NonNull UserHolder holder, int position) {
        ...
        Glide.with(context).load(users.get(position).getProfilePicture()).error(R.drawable.avatar).placeholder(R.drawable.avatar).into(holder.imageView);
    ...
    class  UserHolder extends  RecyclerView.ViewHolder{
        ...
        public UserHolder(@NonNull View itemView) {
            ...
            imageView = itemView.findViewById(R.id.chatpp);
            cameraImg = itemView.findViewById(R.id.camera);
        }
    }
